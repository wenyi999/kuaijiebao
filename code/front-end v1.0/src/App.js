...
class App extends Component {
    ...
    componentDidMount(){
        ...
        this.eventEmitter = emitter.addListener("CallUsername",(username)=>{ this.setState({ username }) }); }
            ...
            <Layout className="layout">
                <Header>
                    ...
                    >
                        ...
                        <Menu.Item key="6"><Link to={"userzone/"+ this.state.username} >个人中心</Link></Menu.Item>
                ...
                <Content style={{ padding: '0 50px' }}>
                    ...
                    <div style={{ background: '#fff', minHeight: 500}}>
                          ...
                          <Route  path="/userzone/:id" component={ Userzone }/>
