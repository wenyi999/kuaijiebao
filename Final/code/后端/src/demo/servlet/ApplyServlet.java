    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            while (it.hasNext()) {
                ...
                UserEntity userEntity=dao1.getByUsername(username);
                Double line=userEntity.getLine();
                System.out.print("\n"+line.toString()+"\n");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (applyStatus.equals("3")) {//还款
                ...
                UserDao dao1=new UserDao();
                UserEntity userEntity=dao1.getByUsername(username);
                ApplyEntity applyEntity=dao.getByAid(a_id);
                userEntity.setLine(userEntity.getLine()+applyEntity.getAmount());
                dao1.update(userEntity);
                ...
                UserDao dao1=new UserDao();
                UserEntity userEntity=dao1.getByUsername(username);
                userEntity.setLine(userEntity.getLine()-amount);
                dao1.update(userEntity);
